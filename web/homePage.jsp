                ...
                <main class="main-content">
                    ...
                    <footer>
                        ...
                        <section class="link">
                            ...
                            <ul>
                                <li>Email</li>
                                <li>sschcm@fe.edu.vn</li>
                            </ul>
                            <ul>
                                <li>Address</li>
                                <li>Khu Công Nghệ Cao Q9</li>
                            </ul>
                            <ul>
                                <li>Social</li>
                                <li>
                                    <a href="https://www.facebook.com/FPTU.HCM/"><i class="fa-brands fa-facebook"></i></a>
                                    <a href="https://www.instagram.com/accounts/login/?next=/fptuniversityhcm/"><i class="fa-brands fa-instagram"></i></a>
                                    <a href="https://zalo.me/3463391620094696986"><i class="fa-brands fa-twitter"></i></a>
                                    <a href="https://www.youtube.com/channel/UCfNrlxNgcTZDJ3jZeSSSJxg"><i class="fa-brands fa-youtube"></i></a>
                                </li>
                            </ul>
                        </section>
                    </footer>
